...
if st.session_state.tipo is not None:
    ...
    if "maior que a porta" in problema:
        ...
        st.write("Este erro é muito comum de acontecer, a borracha estica na hora da instalação ou quando e removida da caixa, mas fique tranquilo isso não é um problema que não possa ser corrigido!",
